...
flags.DEFINE_string("source_dir",os.path.join(home, "data", "squad"), "location where the actual data is stored")
flags.DEFINE_string("test_file_name","test-v1.1.json", "file name of test file")
flags.DEFINE_string("dev_file_name","dev-v1.1.json", "file name of dev file")
...
flags.DEFINE_integer("val_num_batches", 400, "validation num batches [100]")
flags.DEFINE_integer("test_num_batches", 0, "test num batches [0]")
flags.DEFINE_integer("num_epochs", 20, "Total number of epochs for training [12]")
flags.DEFINE_integer("num_steps", 25000, "Number of steps [20000]")
...
flags.DEFINE_integer("word_count_th", 500, "word count th [100]")
flags.DEFINE_integer("char_count_th", 500, "char count th [500]")
flags.DEFINE_integer("sent_size_th", 500, "sent size th [64]")
flags.DEFINE_integer("num_sents_th", 32, "num sents th [8]")
flags.DEFINE_integer("ques_size_th", 70, "ques size th [32]")
flags.DEFINE_integer("word_size_th", 64, "word size th [16]")
flags.DEFINE_integer("para_size_th",260, "para size th [256]")
